...
\newcommand{\ucmark}{\tikz[y=0.80pt,x=0.80pt,yscale=-0.05,xscale=0.05, inner sep=0pt, outer sep=0pt]%
...
gettimeofday({tv_sec=1550586520, tv_usec=313499}, NULL) = 0
 > [vdso]() [0xef0]
        ...
        {\color{black}\tiny{Two frequently used system calls are ~77\% slower on AWS EC2}}
    \end{center}
\end{frame}
...
%\begin{frame}[fragile]{}
    ...
    %\begin{overprint}
        ...
        %\begin{minted}[fontsize=\normalsize,escapeinside=||]{python}
            ...
            %latency average = |\colorbox{White}{1312.903}| ms
        %\end{minted}
        ...
        %\begin{minted}[fontsize=\normalsize,escapeinside=||]{python}
            ...
            %SQL script 1: pg_long.sql
             ...
             %- latency average = |\colorbox{White}{1426.928}| ms
        ...
        %\begin{minted}[fontsize=\normalsize,escapeinside=||]{python}
            %# Experiment 1
            %transaction type: pg_long.sql
            %latency average = |\colorbox{RedOrange}{\textbf{1312.903}}| ms

            %# Experiment 2
            %SQL script 1: pg_long.sql
             %- weight: 1 (targets 50.0% of total)
             %- latency average = |\colorbox{RedOrange}{\textbf{1426.928}}| ms
...
\begin{frame}[fragile]{}
    ...
    \begin{center}
        ...
        \includegraphics[width=0.5\textwidth,center]{mds.png}

        \tiny{
        \href
        {https://www.postgresql.org/message-id/flat/20190514223052.2iufhkjmgod2h7ic%40alap3.anarazel.de}
        {\color{black}{Andres Freund: New intel MDS vulnerability mitigations cause measurable slowdown}}
        }
        ...
        \only<2>{
            \begin{tikzpicture}
                ...
                \draw[
                    line width=0.0mm,
                    color=white,
                ] (1.5,1.0) rectangle (3.0,2.5) node[pos=.5] {\color{black} \Huge{\spin}};
        ...
        \only<1>{
            \begin{tikzpicture}
                ...
                \draw[
                    ...
                    rounded corners=0.2cm,
                    color=white,
                    ] (5.9,-0.85) rectangle (8.1,2.85) node[pos=.5] {};
                ...
                \draw[
                    ...
                    pattern=north west lines,
                    pattern color=green!30
                    ] (6,-0.75) rectangle (8,2.75) node[pos=.5] {\textbf{WAL}};
    ...
    \begin{center}
		...
		\begin{tikzpicture}[
          ...
          to/.style={->,>=stealth',shorten >=1pt,semithick,font=\sffamily\footnotesize},
            ...
            \draw[semithick] (-4,2.5) -- (4,2.5);
			\draw node[fill=red!30] (bytecode) {Bytecode};
			\draw node[above=0.5cm of bytecode, color=white]
                (func) {vfs\_read};
			\draw node[split, fill=gray!30, below=0.5cm of bytecode, color=white] (stack)
                {Stack \nodepart{second} \ldots};
			\draw node[split, fill=yellow!30, left=0.5cm of stack, color=white] (regs)
                {Regs \nodepart{second} \ldots};
			\draw node[split, fill=blue!30, right=0.5cm of stack, color=white] (maps)
                {Maps \nodepart{second} \ldots};
...
\begin{frame}[fragile]{}
    ...
    \begin{center}
        ...
        \includegraphics[width=0.9\textwidth,center]{evil.jpg}
...
\begin{frame}[fragile]{}
    \frametitle{}
    \begin{center}
        \includegraphics[width=0.8\textwidth,center]{linux_block.png}
        \vspace{-5mm}

        \href{https://www.thomas-krenn.com/en/wiki/Linux\_Storage\_Stack\_Diagram}
             {\color{black}\normalsize{Werner Fischer}}
    \end{center}
\end{frame}
...
=> trace 'sbitmap_queue_resize "%d", arg2'

PID     TID     COMM            FUNC             -

22581   22581   postgres        sbitmap_queue_resize 74
22581   22581   postgres        sbitmap_queue_resize 51
22581   22581   postgres        sbitmap_queue_resize 80
22581   22581   postgres        sbitmap_queue_resize 45
22581   22581   postgres        sbitmap_queue_resize 81
22581   22581   postgres        sbitmap_queue_resize 47
