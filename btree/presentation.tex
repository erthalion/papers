...
\begin{frame}[fragile]{}
    ...
    \color{black}\fontsize{6pt}{0}\selectfont
        ...
        Conference on Data Engineering. 10.1109/ICDE.2013.6544834.
    \linespread{1.5}
...
\begin{frame}[fragile]{}
    ...
    \begin{overprint}[12cm]
        ...
        \begin{tikzpicture}[]
            ...
            \draw[dashed] ([xshift=-2cm]left-point) -- ([xshift=2cm]right-point);
        \end{tikzpicture}
        ...
        \begin{tikzpicture}[]
            ...
            \node[draw, minimum width=0.5cm, minimum height=0.5cm, rounded corners=0.1cm, below=1.5cm of nodebox1.south] (log2) {};
            \node[draw, minimum width=0.5cm, minimum height=0.5cm, rounded corners=0.1cm, right=0.5cm of log2] (log3) {};
            \node[draw, minimum width=0.5cm, minimum height=0.5cm, rounded corners=0.1cm, left=0.5cm of log2] (log1) {};
