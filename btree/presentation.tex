    ...
    \begin{overprint}[8cm]
        ...
        \begin{tikzpicture}[]
            ...
            \foreach \i/ \shift in {1/0.35cm,2/0.11cm,3/-0.07cm,4/-0.3cm} {
                \draw[->, btree-line] ([yshift=\shift]indirection-key1\i.center) -- ([yshift=\shift]key1\i.center);
            }
        \end{tikzpicture}
        \end{center}
        ...
        \begin{tikzpicture}[]
          ...
          \linespread{0.5}
          \node[draw, below=1cm of indirection-key12.east, minimum width=1cm, minimum height=1cm, text width=1cm, align=center, rounded corners]
