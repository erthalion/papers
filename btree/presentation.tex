...
\begin{frame}[fragile]{}
    ...
    \begin{overprint}[15cm]
        ...
        \begin{tikzpicture}[]
            ...
            \node[draw, inner sep=0.2cm, behind path, dashed,
...
\begin{frame}[fragile]{}
    ...
    \begin{overprint}[12cm]
        ...
        \begin{tikzpicture}[]
            ...
            \coordinate[below=1cm of key1] (start);
            \draw[->, btree-line] (start.south)
                .. controls ([xshift=1cm] start) and ([yshift=-1cm] key6) ..
                (key6.south);
            \draw[->, btree-line] (key6.south)
                .. controls ([yshift=-1cm] key6) and ([yshift=-1cm] key9) ..
                (key9.south);
            \draw[->, btree-line] (key9.south)
                .. controls ([yshift=-0.9cm] key9) and ([yshift=-0.9cm] key10) ..
                (key10.south);
        ...
        \begin{tikzpicture}[]
            ...
            \coordinate[below=1cm of key6] (start);
            \draw[->, btree-line] (start.south)
                .. controls ([xshift=1cm] start) and ([yshift=-1cm] key10) ..
                (key10.south);
