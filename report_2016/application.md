...
с вживлёнными искусственными сердечными клапанами требуется совершенствовать их конструкции.
...
надежными и близкими по характеристикам к оптимальным.
...
клапанам "идеальной" формы, либо релиастичным клапанам, отличным от
