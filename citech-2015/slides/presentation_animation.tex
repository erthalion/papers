...
\title[Численное моделирование клапанов]{Численное моделирование искусственных сердечных клапанов}
\date{\today}
...
\begin{frame}
\frametitle{Примеры: деформация стенок}
    \animategraphics[autoplay,loop,width=\textwidth]{20}{animation/cylinder2/data_}{1}{199} 
\end{frame}
...
\frametitle{Примеры: поток внутри клапана}
    \animategraphics[autoplay,loop,width=\textwidth]{20}{animation/valve_markers_better/data_}{1}{136} 
\end{frame}
