...
\begin{frame}
    ...
    \begin{figure}
        \includegraphics[width=0.7\textwidth,center]{benchmarks/simple_select_throughput.png}
    \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \textbf{Простая выборка по ключу с индексом}
    \begin{figure}
        \includegraphics[width=0.7\textwidth,center]{benchmarks/simple_select_latency_99.png}
    \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \textbf{Размер таблиц}
    \begin{figure}
        \includegraphics[width=0.7\textwidth,center]{benchmarks/table_size.png}
    \end{figure}
    \end{center}
\end{frame}
