...
user    1m9.127s
sys     0m2.066s
real    |\colorbox{RedOrange}{\textbf{1m38.990s}}|
        \end{minted}
...
user    1m8.559s
sys     0m1.641s
real    |\colorbox{RedOrange}{\textbf{1m32.030s}}|
        \end{minted}
...
\begin{frame}[fragile]{}
    ...
    \begin{center}
        ...
        \begin{tikzpicture}
          \draw (0,0) node[draw] (image) {\includegraphics[width=0.7\textwidth,center]{slide.png}};
          \draw (-3,-3) node[fill=red!30, rounded corners=0.2cm] (popup) {Remember?};

          \draw [overlay, ->, line width=3pt, red] (popup) to [bend right] (image.center);
        \end{tikzpicture}
