...
\end{frame}
\note{
    syscall `fdatasync` for mongodb under strace with `transaction\_sync`
}
...
\end{frame}
\note{
    Haven't tested with PG10, but I don't remember any discussion about fixing that,
    so maybe I'm going to fix it myself.
}
