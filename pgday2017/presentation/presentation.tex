...
\begin{frame}
    ...
    \begin{tikzpicture}[%
      ...
      \node {\textbf{Bson}}
        ...
        child { node {\textbf{node}}
          child { node {\textbf{node}}
              child { node [color=red!45, text=black, top color=red!25, bottom color=red!25] {\textbf{Header}}}
              child { node {\textbf{Content}}}
          }
          child { node [empty] {...}}
        };
...
\begin{frame}
    ...
    \begin{tikzpicture}[%
      ...
      two children at (0.5,-1.2) and (0.5,-2.4)},
      edge from parent path={(\tikzparentnode.south) |- (\tikzchildnode.west)}]
      \node {\textbf{Bson Header}}
        child { node {\textbf{Value type}}}
        child { node {\textbf{Key name}}}
        child { node {\textbf{Value size}}};
    \end{tikzpicture}
...
\begin{frame}
    ...
    \begin{tikzpicture}[%
      ...
      two children at (0.5,-1.2) and (0.5,-2.4)},
      edge from parent path={(\tikzparentnode.south) |- (\tikzchildnode.west)}]
      \node {\textbf{MySQL Json}}
        child { node {\textbf{node}}
          child { node {\textbf{node}}
              child { node {\textbf{Type}}}
              child { node {\textbf{Value}}}
          }
          child { node [empty] {...}}
        };
    \end{tikzpicture}
    ...
    \begin{tikzpicture}[%
      ...
      \node {\textbf{MySQL Json}}
        child { node {\textbf{node}}
          child { node {\textbf{node}}
              child { node {\textbf{Type}}}
              child { node [color=red!45, text=black, top color=red!25, bottom color=red!25]{\textbf{Value}}}
          }
          child { node [empty] {...}}
        };
    \end{tikzpicture}
...
\begin{frame}
    ...
    \begin{tikzpicture}[%
      ...
      two children at (0.5,-1.2) and (0.5,-2.4)},
      edge from parent path={(\tikzparentnode.south) |- (\tikzchildnode.west)}]
      \node {\textbf{MySQL Json Object}}
        child { node {\textbf{Count of elements}}}
        child { node {\textbf{Size}}}
        child { node {\textbf{Pointers to keys}}}
        child { node {\textbf{Pointers to values}}}
        child { node {\textbf{Keys}}}
        child { node {\textbf{Values}}};
    \end{tikzpicture}
...
\begin{frame}
    ...
    \begin{center}
        \begin{itemize}[label={\MVRightarrow}]
            \item MongoDB -- Document -> Elements
            \item Postgresql -- JsonbValue
            \item MySQL -- Value
        \end{itemize}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{center}
        \begin{itemize}[label={\MVRightarrow}]
            \item Postgresql -- BTree, GIN
            \item MongoDB -- BTree
            \item MySQL -- virtual columns, BTree
        \end{itemize}
    \end{center}
\end{frame}
