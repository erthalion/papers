...
\end{frame}
\note{
    try batch \& nice separately,
    provide numbers about how much those numbers vary between runs
}
...
\end{frame}
\note{
    put units, make graph thicker
    mention in the title "read write"
}
...
\end{frame}
\note{
    think how to formulate - stable lower?
...
\end{frame}
\note{
    think how to formulate - not significantly different?
    or plot it differently
}
...
\end{frame}
\note{
    not the logical decoding itself, but if logical decoding is enabled
}
