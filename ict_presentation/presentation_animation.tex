...
\frametitle{Динамика идеального клапана}
    %\animategraphics[autoplay,loop,width=\textwidth]{20}{animation/valve_delaunay3/data_}{50}{50}
    \animategraphics[autoplay,loop,width=\textwidth]{20}{animation/valve_delaunay3/data_}{1}{1}
\end{frame}

\begin{frame}
\frametitle{Распределение примеси}
    %\animategraphics[autoplay,loop,width=\textwidth]{20}{animation/valve_in_mixture/data_}{180}{180}
...
\frametitle{Эффект скручивания створок}
    %\animategraphics[autoplay,loop,width=\textwidth]{20}{animation/rotation/data_}{110}{110}
    \animategraphics[autoplay,loop,width=\textwidth]{20}{animation/rotation/data_}{1}{1}
\end{frame}

\begin{frame}
\frametitle{Динамика <<Юнилайн>>}
    %\animategraphics[autoplay,loop,width=\textwidth]{20}{animation/real_valve/data_}{50}{50}
    \animategraphics[autoplay,loop,width=\textwidth]{20}{animation/real_valve/data_}{1}{1}
\end{frame}

\begin{frame}
\frametitle{Динамика <<Юнилайн>>}
    %\animategraphics[autoplay,loop,width=\textwidth]{20}{animation/uniline_tracks/data_}{50}{50}
...
\frametitle{Расход жидкости}
    \begin{center}
        \includegraphics[width=10cm]{flow_rate_aorta.png}
    \end{center}
\end{frame}
...
\frametitle{Динамика в сосуде с гибкими стенками}
    \animategraphics[autoplay,loop,width=0.9\textwidth]{20}{animation/aneurysm//data_}{60}{60}
\end{frame}
...
\frametitle{Стеноз небольшой степени}
    ...
    \animategraphics[autoplay,loop,width=0.9\textwidth]{20}{animation/thrombus_light_stenosis/data_}{1}{1}
\end{frame}
...
\frametitle{Стеноз большой степени}
    ...
    \animategraphics[autoplay,loop,width=0.9\textwidth]{20}{animation/thrombus_strong_stenosis/data_}{1}{1}
\end{frame}
