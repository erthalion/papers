...
причинами: во-первых,
  ...
  Во-вторых,
  для улучшение качества и продления жизни пациентов с твенными сердечными
  клапанами требуется вживлёнными искусственными сердечными клапанами требуется
...
заболеваниями и повреждениями естесственных клапанов, но при этом не являются
...
\caption{Распределение напряжение по поверхности одной створки во времена t=0,
...
\funding{Работа проводится в рамках проектной части госзадания 1.630.1.2014/K} %%% Specify the organizations and/or grants if required...
